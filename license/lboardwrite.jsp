	...
	<div class="license_section">
		<div class="container">
			<div class="row">
				...
				<tr class="tr_th">
				<th colspan=5>공지게시판 작성</th>
				</tr>
				<tr>
				<td>작성자 :</td><td colspan=4>admin</td>
				</tr>
				<tr>
				<td>글제목 :</td><td colspan=4><input type=text size=50></td>
				</tr>
			
				<tr>
				<td>내용 :</td><td colspan=4><textarea rows="10" cols="60"></textarea></td>
				</tr>
				
				</table>
				<div class="text-right">
				<input type=button value="작성완료" class="btn btn-info" onclick="location.href='mainpage2.jsp'">
				</div>
				<br>
				</form>
